...
def forwards_func(apps, schema_editor):
    ...
    User.objects.create(username="testman@email.com", password=hashed_password, nickname="testnickname", gender="M", phone_number="01099998888", authenticated_university_email="test@univ.ac.kr")
