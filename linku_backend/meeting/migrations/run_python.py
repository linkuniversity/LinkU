...
def forwards_func(apps, schema_editor):
    ...
    if os.environ['LINKU_SERVER_ENVIRONMENT'] != 'local':
        ...
        current_meeting = Meeting.objects.create(title="test current meeting title", place="혜화역 4번 출구", is_current=True)
        ...
        prearranged_meeting = Meeting.objects.create(title="test prearranged meeting title", place="강남역 4번 출구", is_prearranged=True)
